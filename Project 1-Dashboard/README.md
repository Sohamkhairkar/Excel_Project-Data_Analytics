...
The purpose of this data jobs salary dashboard is to assist job searchers in researching the pay for the positions they are interested in and making sure they are receiving fair compensation. 

The information comes from my Excel course, which lays the groundwork for using this potent tool to analyse data. The information provided here includes comprehensive details about job titles, pay, locations, and necessary abilities.

### Dashboard File

My final dashboard is in [Data_jobs_salary_project _1 _(Dashboard).xlsx](https://github.com/Sohamkhairkar/Excel_Project-Data_Analytics/blob/main/Project%201-Dashboard/Data_jobs_salary_project%20_1%20_(Dashboard).xlsx).
